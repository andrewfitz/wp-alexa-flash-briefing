...
# main config
PLUGINSLUG="wp-alexa-flash-briefing"
CURRENTDIR=`pwd`
MAINFILE="wp-alexa-flash-briefing.php" # this should be the name of your main php file in the wordpress plugin
...
git tag -a "$NEWVERSION2" -m "Tagging version $NEWVERSION1"
